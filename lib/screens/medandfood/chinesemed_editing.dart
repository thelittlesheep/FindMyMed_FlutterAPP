...
class ChinesemedicineEditing extends StatefulWidget {
  static const String routeName = '/ChinesemedicineEditing';

  @override
  _WestmedicineEditingState createState() => _WestmedicineEditingState();
}

class _WestmedicineEditingState extends State<ChinesemedicineEditing> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: Text('個人中藥更新')),
